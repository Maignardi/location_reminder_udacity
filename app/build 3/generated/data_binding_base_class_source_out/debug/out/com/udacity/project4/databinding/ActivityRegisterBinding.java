...
public final class ActivityRegisterBinding implements ViewBinding {
  ...
  @NonNull
  public final Button registerButtonGoogle;

  private ActivityRegisterBinding(@NonNull ConstraintLayout rootView,
      @NonNull EditText emailEditText, @NonNull EditText passwordEditText,
      @NonNull Button registerButton, @NonNull Button registerButtonGoogle) {
    this.rootView = rootView;
    this.emailEditText = emailEditText;
    this.passwordEditText = passwordEditText;
    this.registerButton = registerButton;
    this.registerButtonGoogle = registerButtonGoogle;
  }
  ...
  public static ActivityRegisterBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.registerButtonGoogle;
      Button registerButtonGoogle = ViewBindings.findChildViewById(rootView, id);
      if (registerButtonGoogle == null) {
        break missingId;
      }

      return new ActivityRegisterBinding((ConstraintLayout) rootView, emailEditText,
          passwordEditText, registerButton, registerButtonGoogle);
    }
